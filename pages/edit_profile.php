...
<main class="container my-5 fullHeight">
    <div class="go-back text-left mb-4">
        <button class="btn text-success" onclick="window.history.back();">
    ...
    <form class="needs-validation" id="editProfileForm" method="POST" class="w-100" style="max-width:600px;margin:0 auto;" novalidate>
        <div class="mb-3">
